...
void main() {
  group('findPossible3wa Tests', () {
    ...
    test('Multiple what3words addresses', () {
      ...
      var result =
          api.findPossible3wa("Check filled.count.soap and index.home.raft.");
    ...
    test('No what3words addresses', () {
      ...
      var result =
          api.findPossible3wa("This string has no valid what3words addresses.");
      expect(result, isEmpty);
    });

    test('Valid what3words address embedded in text', () {
      // This should return a list with one address found within text
      var result = api.findPossible3wa(
          "Leave the package at filled.count.soap or at the back door.");
      expect(result, equals(["filled.count.soap"]));
    });
    ...
    test('Edge case - address with invalid characters', () {
      ...
      var result =
          api.findPossible3wa("Address like filled.count.soap! is invalid.");
      expect(result, equals(["filled.count.soap"]));
    });
  });
}
